...
const Process = () => {
    return (
        <div>
          <section className="bg-white dark:bg-black txt-black dark:text-white py-10 px-5 lg:px-14 transition-colors duration-300">
                <div className="text-center mb-12">
                    <p className="text-orange-500 font-medium uppercase tracking-wider mb-2">Our Service</p>
