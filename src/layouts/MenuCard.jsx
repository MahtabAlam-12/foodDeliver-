...
const MenuCard = ({name, price, tag, image}) => {
    return(
        <div className="group bg-gray-100 dark:bg-[#1f1d2b] p-6 hover:bg-orange-500 dark:hover:bg-orange-500 rounded-2xl transition-all duration-300">
            <div className="relative mb-4">
                <img src={image} alt={name} className="mx-auto" />
                {tag && <span className="absolute -top-3.5 -left-4 bg-orange-500 text-white group-hover:bg-black text-xs px-2 py-1 ">{tag}</span>}
            </div>
